...
Group.new("HoverNormal", colors.none, colors.none, styles.NONE)
Group.new("NormalFloat", colors.none, colors.red, styles.NONE)
Group.new("Normal", colors.base1, colors.NONE, styles.NONE)
Group.new("CmpNormal", colors.none, colors.none, styles.NONE)
